...
add_block('simulink/Sources/Step',[mdl '/ModeStep'],'Time','5','Before','FanCtrlMode_e.MANUAL','After','FanCtrlMode_e.AUTO','Position',[30 210 90 235]);
...
add_line(mdl,'ModeStep/1','TopRef/5');
